...
describe('TodoApplication', () => {
    ...
    context('when dealing with a single persisted todo', () => {
        ...
        it('rejects request with invalid keys - constructor.prototype', async () => {
            ...
            const res = await client
                ...
                .expect(400);
            testlab_1.expect((_a = res.body) === null || _a === void 0 ? void 0 : _a.error).to.containEql({
                statusCode: 400,
    ...
    context('allows logging to be reconfigured', () => {
        it('logs http requests', async () => {
            ...
            testlab_1.expect(logs.length).to.eql(1);
            testlab_1.expect(logs[0]).to.match(/"GET \/todos HTTP\/1\.1" 200 - "-"/);
        });
    });
    ...
    it('queries todos with string-based order filter', async () => {
        ...
        await client
            ...
            .expect(200, testlab_1.toJSON([todoCompleted, todoCompleted2, todoInProgress]));
    });
    ...
    it('queries todos with exploded string-based order filter', async () => {
        ...
        await client
            ...
            .expect(200, [
            testlab_1.toJSON(todoCompleted),
            testlab_1.toJSON(todoCompleted2),
            testlab_1.toJSON(todoInProgress),
        ]);
    });
    it('queries todos with exploded array-based fields filter', async () => {
        ...
        await client
            ...
            .expect(200, testlab_1.toJSON([{ title: 'go to sleep' }]));
    });
